...
public class Pool extends CapacityCheckinBase implements ICountryClubFacility, Serializable {
    ...
    protected void initializeHours() {
        hoursOfOperationMap.put("MONDAY", new String[] { "08:00", "23:00" });
        hoursOfOperationMap.put("TUESDAY", new String[] { "08:00", "23:00" });
        hoursOfOperationMap.put("WEDNESDAY", new String[] { "08:00", "23:00" });
        hoursOfOperationMap.put("THURSDAY", new String[] { "08:00", "23:00" });
        hoursOfOperationMap.put("FRIDAY", new String[] { "08:00", "23:00" });
        hoursOfOperationMap.put("SATURDAY", new String[] { "10:00", "23:00" });
        hoursOfOperationMap.put("Sunday", new String[] { "10:00", "14:00" });
    }
